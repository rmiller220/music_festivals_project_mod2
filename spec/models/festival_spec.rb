...
festival_appearances: 10,
festival: summer_camp)}
let!(:pretty_lights) { Artist.create!(name: "Pretty Lights",
explicit_content: false,
performance_day: "Friday, Saturday",
number_of_performances: 1,
festival_appearances: 3,
...
let!(:bassnectar) { Artist.create!(name: "Bassnectar",
 ...
 festival_appearances: 2,
 festival: all_good)}
let!(:yonder) { Artist.create!(name: "Yonder Mountain String Band",
 explicit_content: false,
 performance_day: "Sunday",
 number_of_performances: 1,
 ...
 festival: all_good)}
    it "sorts artists alphabetically" do
      ...
      expect(summer_camp.sort_alphabetically(summer_camp.artists)).to eq([bone_thugs, pretty_lights, sts9])
    end
  end
end